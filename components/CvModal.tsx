  ...
  return (
    <div className={styles.newModal}>
      ...
      <div>
        <Infos
          title='Objective'
          description='Software Engineer with 2 years of experience in JavaScript and React.js'
        />
        <Infos
          title='Education'
          description='Computer Engineering Undergrad, Sivas Cumhuriyet Üniversitesi'
        />
        <Infos
          title='Skills'
